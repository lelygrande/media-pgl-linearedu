...
<div class="mb-3">
    <input type="text" id="searchSiswa" class="form-control" placeholder="Cari nama siswa..." style="border-radius: 999px; max-width: 320px;">
</div>
...
.row-hover:hover{background-color:#f8fafc!important;transition:.15s ease-in-out;}
