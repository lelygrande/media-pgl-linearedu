...
@section('nav')
    <a href="{{ route('subbabB_gradiensatutitik') }}" class="btn btn-prev px-4 rounded-pill">
        ← Prev
    </a>
    <a href="{{ route('subbabB_gradienpersamaan1') }}" class="btn btn-next px-4 rounded-pill fw-semibold">
        Next →
    </a>
@endsection
